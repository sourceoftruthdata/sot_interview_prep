...
def iv_woe(data, target, bins=10, show_woe=False):
    """
    fill the null value in the dataframe inpalce
    :param data: input dataset ,pandas.DataFrame type
    :param target:  name of data target column/attribute
    :param bins: number of woe bins, default=10
    :param show_woe: display woe values
    """
